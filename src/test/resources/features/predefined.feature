...
#    Then I do not see error
  ...
  Scenario: Verify "DateOfBirth" date picker
    ...
    And I click on element using JavaScript with xpath "//option[@value='6']"
    And I click on element with xpath "//a[text()='3']"
    Then element with xpath "//td[@class=' ui-datepicker-days-cell-over  ui-datepicker-current-day']" should have attribute "data-month" as "6"
    Then element with xpath "//td[@class=' ui-datepicker-days-cell-over  ui-datepicker-current-day']" should have attribute "data-year" as "1986"
    And element with xpath "//a[@class='ui-datepicker-days-cell-over  ui-datepicker-current-day']" should have text as "3"
